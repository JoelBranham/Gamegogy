...
| Test Gamegogy Default Values     | Start Application                 | edu.jsu.mcis.gamegogy.Main       | ${service_url_with_slash} |
...
| Test Gamegogy Course Select      | Start Application                 | edu.jsu.mcis.gamegogy.Main       | ${service_url_no_slash}   |
|                                  | Select Window                     | Gamegogy                         |                           |
...
|                                  | Close Window                      | Gamegogy                         |                           |
| Test Gamegogy Column Select      | Start Application                 | edu.jsu.mcis.gamegogy.Main       | ${service_url_with_slash} |
|                                  | Select Window                     | Gamegogy                         |                           |
