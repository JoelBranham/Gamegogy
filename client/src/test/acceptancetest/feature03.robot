...
| Test Gamegogy Default Values     | Start Application                 | edu.jsu.mcis.gamegogy.Main       |                     |
...
| Test Gamegogy Course Select      | Start Application                 | edu.jsu.mcis.gamegogy.Main       |                     |
|                                  | Select Window                     | Gamegogy                         |                     |
...
|                                  | Close Window                      | Gamegogy                         |                     |
| Test Gamegogy Column Select      | Start Application                 | edu.jsu.mcis.gamegogy.Main       |                     |
|                                  | Select Window                     | Gamegogy                         |                     |
