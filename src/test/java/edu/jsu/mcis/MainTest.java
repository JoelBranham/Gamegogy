...
public class MainTest{
	...
	@Test
	public void testCorrectStudentArgsYieldCorrectOutput()throws MalformedURLException, IOException{
		Main.main(validStudentArgs);
		assertEquals("[111111] Jerrod Shields jshields@jsu.edu", out.toString().trim());
	}

	@Test
	public void testInvalidStudentArgsThrowsStudentException()throws MalformedURLException, IOException{
	...
	@Test
	public void testCorrectCourseArgsYieldCorrectOutput()throws MalformedURLException, IOException{
		Main.main(validCourseArgs);
		assertEquals("[99000] Spring 2013 (11 students)", out.toString().trim());
	}
	
	@Test
	public void testInvalidCourseArgsThrowsCourseException()throws MalformedURLException, IOException{
		boolean thrown = false;
		try{
	...
	@Test
	public void testCorrectSingleArgYieldsCorrectOutput1()throws MalformedURLException, IOException{
	...
	@Test
	public void testCorrectSingleArgYieldsCorrectOutput2()throws MalformedURLException, IOException{
